    ...
    <section id="body">
        <div class="col-md-6 offset-md-3">
            <div class="body__form">
                <form method="post" name="package_secation" onSubmit="return FormValidation()" id="form" action="data/send_data.php">
                    <select class="form-select mb-3" name="package_type" onchange="packeges()" id="choose_packegs" aria-label="Default select example">
                    ...
                    <div id="promational_pakege">
                        <div class="mb-3 ">
                            <input type="text" class="form-control" id="full_name" required placeholder="Full Name" name="full_name">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-6 mb-3 ">
                                <select class="form-select form-control" name="thana" aria-label="Default select example">
                                    <option selected disabled>Thana name</option>
                                    <option value="Thana name 2">Thana name 1</option>
                                    <option value="Thana name 2">Thana name 2</option>
                                    <option value="Thana name 3">Thana name 3</option>
                                    <option value="Thana name 4">Thana name 4</option>
                                    <option value="Thana name 5">Thana name 5</option>
                                  </select>
                            </div>

                            <div class="col-md-6 mb-3 ">
                                <select class="form-select form-control" name="area_name" aria-label="Default select example">
                                    <option selected disabled>Area name</option>
                                    <option value="Area name 1">Area name 1</option>
                                    <option value="Area name 2">Area name 2</option>
                                    <option value="Area name 3">Area name 3</option>
                                    <option value="Area name 4">Area name 4</option>
                                    <option value="Area name 5s">Area name 5</option>
                                  </select>
                            </div>
                        </div>
